...
namespace CAESimulation
{
    ...
    {
        public static DataTable dtCombined;
        public static DataTable dtTb;

        public Resultdiag(DataTable dtCombine, DataTable dtTbdata)
        {
            dtCombined = dtCombine;
            dtTb = dtTbdata;
            InitializeComponent();
            ShowGraph();
        }
        public void ShowGraph()
        {
            ...
            var myModel = new PlotModel { Title = "Wind Velocity" };
            ...
            object[] arrObj = dtCombined.Select().Select(x => x["SurplusElec"]).ToArray();
